 ...
 */
public class Berlanggananadapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Berlanggananadapter(OnLoadMoreListener onLoadMoreListener) {
        this.onLoadMoreListener = onLoadMoreListener;
        this.DataSet = new ArrayList<BerlanggananDataset>();
    }
    ...
    public void addAll(ArrayList<BerlanggananDataset> lst){
        DataSet.clear();
        DataSet.addAll(lst);
        notifyDataSetChanged();
    }

    public void addItemMore(ArrayList<BerlanggananDataset> lst){
        DataSet.addAll(lst);
